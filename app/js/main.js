...
/* harmony import */ var _components_creditCard__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(_components_creditCard__WEBPACK_IMPORTED_MODULE_24__);
...
function onInputChange(input, newValue) {
  ...
  if (firstFour.startsWith("4")) {
    logo.src = "./img/visa.svg";
  } else if (firstFour.startsWith("5")) {
    logo.src = "./img/master-card.svg";
  }
}
function updateInputValue(input, extraValue) {
  let start = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  let end = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
